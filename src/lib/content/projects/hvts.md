...
![The image shows a bar-chart comparing the coverage from The New York Times and Zeit Online based on countries.](/uploads/hvts/hvts-trees.png 'Comparison between coverage of specific countries between NYT and Zeit Online')
...
![The image shows a browsing widget based on a map. The widget allows readers to search if countries have been covered together and to what extent.](/uploads/hvts/hvts-map.png 'Browsing widget to compare geographic coverage across the two newspapers')
