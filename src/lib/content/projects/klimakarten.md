...
himage: /uploads/klimaland/klimaland-preview.webp
...
![The image shows two physical postcards compared, one for Germany and one for Potsdam. The visualization shows data for the mobility sector, specifically the number of cars per inhabitant for the two areas.](/uploads/klimaland/dsc0291-2048x1365.webp 'The physical postcards')
...
![The image shows the default mode of the web interface for Klimakarten. Without any set parameter in the search bar, all postcards are visible for the indicators. The postcards are arranged on the screen as they would lie on the table, by interacting with them the user can activate them and see the details of each visualization.](/uploads/klimaland/screenshot-2024-01-01-at-20.42.51.webp 'The first view of the web prototype')
